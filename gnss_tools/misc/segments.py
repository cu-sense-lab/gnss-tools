...
# def find_nondecreasing_sequence_segments(
#     sequence: NDArray[np.int_],
#     allow_delta_size: Optional[float] = None
#     ) -> List[Tuple[int, int]]:
#     """Find contiguous segments in a sequence where the delta between values is less than or equal to the allow_delta_size."""
